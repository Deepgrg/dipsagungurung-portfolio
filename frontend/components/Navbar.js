...
const Navbar = () => {
  return (
    <header className="h-14 py-4 bg-[#1D1D1F] bg-opacity-80 backdrop-filter backdrop-blur-md z-10  fixed top-0 left-0 w-full flex justify-center items-center border-b border-gray-200 border-opacity-25">
