  ...
  return (
    ...
    >
      ...
      <div className=" max-w-7xl grid grid-cols-4 gap-4 md:gap-5 lg:gap-6">
        {/* Item A */}
        <div className="col-span-4 lg:col-span-2 row-span-2 bg-[#1D1D1F] p-10 lg:p-16 rounded-3xl border-gray-200 border-opacity-10 border ">
        ...
        {/* Item B.i */}
        <div className="bg-[#1D1D1F] col-span-2 lg:col-span-1 py-12 rounded-3xl flex flex-col items-center justify-center border-gray-200 border-opacity-10 border">
        ...
        {/* Item C */}
        <div className="col-span-4 lg:col-span-1 h-48 lg:h-auto  flex items-center justify-center rounded-3xl bg-pixel-pattern border-gray-200 border-opacity-10 border">
        ...
        {/* Item D */}
        <div className="bg-[#1D1D1F] col-span-4 lg:col-span-3 flex items-center justify-center rounded-3xl h-96 border-gray-200 border-opacity-10 border">
        ...
        {/* Item F */}
        <div className="bg-[#1D1D1F] col-span-4 lg:col-span-2 rounded-3xl px-10 md:px-14 py-11 md:h-80 lg:h-auto border-gray-200 border-opacity-10 border">
        ...
        {/* Item G */}
        <div className=""></div>
        <div className="col-span-4 md:col-span-2 place-content-center bg-[#1D1D1F] rounded-3xl h-auto  border-gray-200 border-opacity-10 border  ">
          <div className="">
            <Image
              src="/Techs.png"
              width={220}
